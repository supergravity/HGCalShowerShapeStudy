...
void makePlots::Loop()
{
  ...
  TH2D* TwoPad_corr100=new TH2D("TwoPad_corr100","",9,0.5,9.5,1000000,0.,10.);
  ...
  for (Long64_t entry=0;entry<nentries;++entry){
    ...
    // ===== Preselection =====
      ...
      //  //Shower Depth Cuts
      //  //
      //  //if (!(shDepth > 6 && shDepth < 15))
      //  if (!(shDepth > 6 && shDepth < 8))
      //  //if (!(shDepth > 8 && shDepth < 10))
      //  //if (!(shDepth > 10 && shDepth < 12))
      //  
      //  {
      //      Clear()
      //      continue;
